{ runtimeShell, writeShellScriptBin, curl, jq, coreutils, gawk, lib }:
lib.warn
  "`nix-prefetch-modrinth` is deprecated; use `nix-modrinth-prefetch` instead. see CHANGELOG.md for more information"
  (
